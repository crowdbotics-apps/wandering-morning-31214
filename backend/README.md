...
## Project Structure
    ...
    ├── wandering_morning_31214  # Django project configurations
...
1. Clone this repo and `cd wandering_morning_31214`
...
2. Clone this repo and `cd wandering_morning_31214`
